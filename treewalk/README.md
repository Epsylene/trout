...
Treewalk interpreter for a simple dynamically-typed programming language, from the first part of the book, implemented in Rust with some changes along the way. The program consists of four main parts:
